        ...
        <div class="col-md-10 personal-info" style="border: 1px soild black">
          ...
          <b-card>
            ...
            <b-form>
              ...
              <b-button @click="updateUserInfo" variant="primary"
  ...
  methods: {
    ...
    updateUserInfo() {
      if (this.avatar) {
        ...
        axios
          .post(`${this.config.file_server_endpoint}/users/avatar`, formData)
          .then((res) => {
            console.log(res);
          })
          .catch((e) => {
